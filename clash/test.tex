...
\begin{itemize}
	\item aaaaaaaaaaaaaaaaaaaaaaaaaaa
...
\begin{itemize}
  ...
  \begin{enumerate}[leftmargin=15pt]
    ...
    \begin{enumerate}
      ...
      \item \textbf{[3rd Obelisk]} Roll 2 \svg{treasure} and choose 1 to resolve; then, gain \svg{morale_positive} and \svg{movement}.
  ...
  \item A player who possesses the title of ``\textcolor{cobalt}{Grail Knight}'' may not use the Diplomacy Ability Card to Recruit Neutral \svg{azure} Units.
  ...
  \item To obtain the Grail Token, a player’s Hero must spend 2 \svg{movement} on the Field with the Grail.
  ...
  \item Once cleansed, the Grail Token behaves like a Permanent Card that does not count towards your hand limit and cannot be discarded; it grants the following effect when played: ``$\infty$ Once during each Combat Round, if the Hero is a \textcolor{cobalt}{Grail Knight}, discard a Card to remove up to 2 \svg{damage} from your Units.''
\end{itemize}

\vspace*{\fill}

\begin{center}
  \transparent{0.2}{\includegraphics[width=0.5\linewidth, keepaspectratio]{\art/bless.png}}
\end{center}
